...
function storeName(displayName) {
    // Your code here
    sessionStorage.setItem('disName', displayName);
}

// For restoring user's display name, if set in the past
function restoreName() {
    // Your code here
    const disName = sessionStorage.getItem('disName');
    if (disName) {
        setInputValue('display-name', disName);
    } else {
        resetName();
    }
}
...
function clearName() {
    // Your code here
    sessionStorage.removeItem('disName');
}
